...
function toggleMenu() {
    ...
    toggleElement(document.querySelector('.nav-container'));
...
function themeInit() {
    ...
    // document.getElementById('markdown-navButton').onclick = (e) => {
    //     toggleElement(document.getElementById('nav-container'));
    // };
